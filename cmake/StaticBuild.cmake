...
macro(find_static_library var)
  ...
  message(STATUS "Looking for static ${ARGS_NAMES}")
  find_library(${var} NAMES ${STATIC_NAMES} HINTS ${ARGS_HINTS})
  if(${var})
    message(STATUS "Looking for static ${ARGS_NAMES} - found")
  else()
    message(STATUS "Looking for static ${ARGS_NAMES} - not found")
  endif()

  if(NOT ${var})
    message(STATUS "Looking for dynamic ${ARGS_NAMES}")
    find_library(${var} NAMES ${ARGS_NAMES} HINTS ${ARGS_HINTS})
    if(${var})
      message(STATUS "Looking for dynamic ${ARGS_NAMES} - found")
      message("Could not find static version of \"${ARGS_NAMES}\", using dynamic linking")
    else()
      message(STATUS "Looking for dynamic ${ARGS_NAMES} - not found")
    endif()
  endif()
endmacro()
...
if(BUILD_STATIC)
  ...
  if(GNUTLS_FOUND)
    ...
    find_static_library(BROTLIDEC_LIBRARY NAMES brotlidec
      HINTS ${PC_GNUTLS_LIBDIR} ${PC_GNUTLS_LIBRARY_DIRS})
    find_static_library(BROTLICOMMON_LIBRARY NAMES brotlicommon
      HINTS ${PC_GNUTLS_LIBDIR} ${PC_GNUTLS_LIBRARY_DIRS})
