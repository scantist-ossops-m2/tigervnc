...
#endif
    static char const*
    pgettext_aux(char const* domain, char const* msg_ctxt_id, char const* msgid, int category)
{
  char const* translation = dcgettext(domain, msg_ctxt_id, category);
...
#endif
    static char const*
    npgettext_aux(char const*       domain,
                  ...
                  int               category)
{
  char const* translation = dcngettext(domain, msg_ctxt_id, msgid_plural, n, category);
...
#endif
    static char const*
    dcpgettext_expr(char const* domain, char const* msgctxt, char const* msgid, int category)
{
...
#endif
    static char const*
    dcnpgettext_expr(char const*       domain,
                     char const*       msgctxt,
                     char const*       msgid,
                     char const*       msgid_plural,
                     unsigned long int n,
