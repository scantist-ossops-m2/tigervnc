...
{
public:
    QMenuSeparator(QWidget* parent = nullptr) : QAction(parent)
    {
        setSeparator(true);
    }
};
...
{
public:
    QCheckableAction(QString const& text, QWidget* parent = nullptr) : QAction(text, parent)
    {
        setCheckable(true);
    }
};
...
{
public:
    QFullScreenAction(QString const& text, QWidget* parent = nullptr) : QCheckableAction(text, parent)
    {
...
{
public:
    QRevertSizeAction(QString const& text, QWidget* parent = nullptr) : QAction(text, parent)
    {
...
{
public:
    QKeyToggleAction(QString const& text, int keyCode, quint32 keySym, QWidget* parent = nullptr)
        : QCheckableAction(text, parent), keyCode_(keyCode), keySym_(keySym)
    {
...
{
public:
    QMenuKeyAction(QString const& text, QWidget* parent = nullptr) : QAction(text, parent)
    {
        connect(this, &QAction::triggered, this, []() {
            int     dummy;
            int     keyCode;
...
{
public:
    QCtrlAltDelAction(QString const& text, QWidget* parent = nullptr) : QAction(text, parent)
    {
        connect(this, &QAction::triggered, this, []() {
            QAbstractVNCView* view = AppManager::instance()->view();
...
{
public:
    QMinimizeAction(QString const& text, QWidget* parent = nullptr) : QAction(text, parent)
    {
        connect(this, &QAction::triggered, this, []() {
            QAbstractVNCView* view = AppManager::instance()->view();
            view->showMinimized();
...
{
public:
    QDisconnectAction(QString const& text, QWidget* parent = nullptr) : QAction(text, parent)
    {
        connect(this, &QAction::triggered, this, []() {
            QApplication::quit();
        });
...
{
public:
    QOptionDialogAction(QString const& text, QWidget* parent = nullptr) : QAction(text, parent)
    {
        connect(this, &QAction::triggered, this, []() {
...
{
public:
    QRefreshAction(QString const& text, QWidget* parent = nullptr) : QAction(text, parent)
    {
        connect(this, &QAction::triggered, this, []() {
...
{
public:
    QInfoDialogAction(QString const& text, QWidget* parent = nullptr) : QAction(text, parent)
    {
        connect(this, &QAction::triggered, this, []() {
...
{
public:
    QAboutDialogAction(QString const& text, QWidget* parent = nullptr) : QAction(text, parent)
    {
        connect(this, &QAction::triggered, this, []() {
...
void QAbstractVNCView::setQCursor(QCursor const&)
{
}
...
void QAbstractVNCView::filterPointerEvent(rfb::Point const& pos, int mask)
{
    if (ViewerConfig::config()->viewOnly())
    {
        return;
