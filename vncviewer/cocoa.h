...
NSCursor* cocoa_set_cursor(NSView* view, QCursor const* cursor);
...
int cocoa_is_keyboard_sync(void const* event);
int cocoa_is_keyboard_event(void const* event);

int  cocoa_is_key_press(void const* event);
bool cocoa_is_mouse_entered(void const* event);
bool cocoa_is_mouse_exited(void const* event);
bool cocoa_is_mouse_moved(void const* event);

int cocoa_event_keycode(void const* event);
int cocoa_event_keysym(void const* event);
...
void cocoa_get_mouse_properties(void const* event, int* x, int* y, int* buttonMask);
