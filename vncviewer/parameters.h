...
class ViewerConfig : public QObject
{
  ...
  Q_PROPERTY(
      QString preferredEncoding READ preferredEncoding WRITE setPreferredEncoding NOTIFY preferredEncodingChanged)
  Q_PROPERTY(
      int preferredEncodingNum READ preferredEncodingNum WRITE setPreferredEncodingNum NOTIFY preferredEncodingChanged)
  Q_PROPERTY(
      bool customCompressLevel READ customCompressLevel WRITE setCustomCompressLevel NOTIFY customCompressLevelChanged)
  ...
  Q_PROPERTY(int pointerEventInterval READ pointerEventInterval WRITE setPointerEventInterval NOTIFY
                 pointerEventIntervalChanged)
  Q_PROPERTY(
      bool emulateMiddleButton READ emulateMiddleButton WRITE setEmulateMiddleButton NOTIFY emulateMiddleButtonChanged)
  Q_PROPERTY(bool dotWhenNoCursor READ dotWhenNoCursor WRITE setDotWhenNoCursor NOTIFY dotWhenNoCursorChanged)
  Q_PROPERTY(bool fullscreenSystemKeys READ fullscreenSystemKeys WRITE setFullscreenSystemKeys NOTIFY
                 fullscreenSystemKeysChanged)
...
public:
  char const*      SERVER_HISTORY     = "tigervnc.history";
  static int const SERVER_PORT_OFFSET = 5900; // ??? 5500;
  ...
  //
  QStringList serverHistory() const
  {
  ...
  int gatewayLocalPort() const
  {
    return gatewayLocalPort_;
  }
...
public slots:
  QString toLocalFile(QUrl const url) const;
