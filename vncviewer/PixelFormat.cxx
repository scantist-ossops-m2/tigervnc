...
{
  if (!isSane())
    throw rdr::Exception("invalid pixel format");
...
void PixelFormat::read(rdr::FdInStream *is)
{
  bpp = is->readU8();
  depth = is->readU8();
  bigEndian = is->readU8();
...
void PixelFormat::write(rdr::FdOutStream *os) const
{
  os->writeU8(bpp);
  os->writeU8(depth);
...
rfb::Pixel PixelFormat::pixelFromPixel(const PixelFormat &srcPF, rfb::Pixel src) const
{
  rdr::U16 r, g, b;
...
#define INBPP 8
#define OUTBPP 8
#include "rfb/PixelFormatBPP.cxx"
#undef OUTBPP
#define OUTBPP 16
#include "rfb/PixelFormatBPP.cxx"
#undef OUTBPP
